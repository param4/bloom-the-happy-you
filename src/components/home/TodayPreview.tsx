    ...
    <View className="mt-5">
      <View className="mb-2.5 flex-row items-center justify-between">
        ...
        <Pressable onPress={onOpenList} hitSlop={8}>
          <Text className="font-display text-xs text-lav-deep">Open list</Text>
        </Pressable>
      </View>
      <Card className="rounded-[20px] p-4">
        ...
        {todos.length > 0 && doneCount === todos.length && (
          <View className="mt-2.5 flex-row items-center gap-1.5">
            <Flower2 size={16} color={colors.sageDeep} />
            <Text className="font-display text-[13px] text-sage-deep">
