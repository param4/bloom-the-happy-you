...
export function Screen({ scroll = true, padBottom = 32, children }: PropsWithChildren<ScreenProps>) {
  ...
  return (
    <ScrollView
      ...
      contentContainerStyle={{ paddingTop: insets.top, paddingBottom: padBottom }}
